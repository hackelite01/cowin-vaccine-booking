package dev.mayank.cowinvaccinebook.service
...
import dev.mayank.cowinvaccinebook.data.model.Center
import dev.mayank.cowinvaccinebook.data.model.Session
import dev.mayank.cowinvaccinebook.repository.CowinAppRepository
import dev.mayank.cowinvaccinebook.usecase.*
import dev.mayank.cowinvaccinebook.usecase.model.*
import dev.mayank.cowinvaccinebook.view.activity.CowinBookingActivity
import dev.mayank.cowinvaccinebook.view.activity.MainActivity
...
class CowinBookingService: Service() {
    ...
    companion object {
        const val CHANNEL_ID = "dev.mayank.cowinvaccinebook.CowinBookingChannel"
        private const val NOTIFICATION_ID = 3455
        private const val WAKE_LOCK_TAG = "dev.mayank.cowinvaccinebook:WAKE_LOCK"
    }
